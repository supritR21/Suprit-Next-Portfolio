...
export default function ProjectCard({ project, index, activeCategory }) {
  // Ensure category filtering works properly
  const isVisible =
    activeCategory === "all" ||
      ...
      >
        ...
        <div className="relative w-full aspect-video">
          <Image
            ...
            className="rounded-3xl grayscale group-hover:grayscale-0 transition-all duration-500 ease-in-out"
          />

          {/* Overlay gradient */}
          <div className="absolute inset-0 bg-linear-to-t from-black/70 via-black/20 to-transparent opacity-70 group-hover:opacity-60 transition-all duration-500"></div>
        ...
        {/* Content Overlay */}
        <div className="absolute inset-0 flex flex-col justify-end items-start p-6 text-left transition-all duration-500 group-hover:bg-white/90 group-hover:backdrop-blur-xl">
          <motion.div
